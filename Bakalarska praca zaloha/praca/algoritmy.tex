...
Nevyužijeme.
Obvyklé pridávanie poľa navštívených do implementácií na predídenie zacyklenia.
Nekonečné grafy.
...
V prípade Bellman - Fordovho algoritmu je nám opäť na obtiaž jeho strohá funkcionalita, a teda zisťovanie cien najlacnejších ciest, zatiaľ čo my žiadame poznať celú nájdenú cestu. Modifikácia kódu je ale jednoduchá, rovnaká ako pre dijkstru - pre kaźdý vrchol si navyše zapamätáme, z ktorého vrcholu sme sa doň dostali.\newline
