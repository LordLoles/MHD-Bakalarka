...
Nech $G = (V, E)$ je graf. Nech $P = (V', E'), P\cap G$, kde $V' = \{x_{0}, x_{1}, ..., x_{k}\}$ a $E' = \{x_{0} x_{1}, x_{1} x_{2}, ..., x_{k-1} x_{k}\}$, pričom všetky $x_{i}$ sú po dvoch rôzne. Potom $P$ nazývame \textit{cestou} v grafe $G$. Ak $k\geq 3$ a vrcholy sú rôzne až na rovnosť $x_{0} = x_{k}$, potom nazveme $P$ \textit{cyklom}, prípadne \textit{kružnicou} \ref[kapitola 1.4]{bang2008digraphs}.
